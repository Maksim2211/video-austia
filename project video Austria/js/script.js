document.addEventListener("DOMContentLoaded", () => {
    ...
    const i18n = {
        en: {
            ...
            "footer.link.email": "Email the authors (replace with your email)",
        ...
        uk: {
            ...
            "footer.link.email": "Написати авторам (заміни email на свій)",
    ...
    const PLACE_DETAILS = {
        "ploshcha-700": {
            img: "pictures/700.png",
            imgAlt: "700th Anniversary Square in Cherkasy",
           en: {
        ...
        "naberezhna": {
            img: "pictures/n1.jpg",
            imgAlt: "Cherkasy Embankment over the Dnipro",
           en: {
        ...
        "druzhba-narodiv": {
            img: "pictures/d1.png",
            imgAlt: "Druzhba Narodiv Street in Cherkasy",
            en: {
        ...
        "soborna-ploshcha": {
            img: "pictures/sb1.jpg",
            imgAlt: "Soborna Square in the centre of Cherkasy",
            en: {
        ...
        "dolina-pagorb": {
            img: "pictures/dt1.jpg",
            imgAlt: "Rose Valley and Hill of Glory with view over the Dnipro",
            en: {
            ...
            uk: {
                ...
                textExtra:
                    "Спускаючись від меморіалу, ви потрапляєте в Долину троянд — ландшафтний парк, що слугує містком між центром міста та річкою. Його унікальною візитівкою є велетенський сонячний годинник у формі птаха журавля, діаметром 15 метрів. Якщо на пагорбі панує урочиста тиша і пам'ять, то долина внизу сповнена життя. Це улюблена локація міста для джазових фестивалів просто неба, фуд-кортів та вечірніх прогулянок біля фонтанів. Контраст між монументальною історією зверху та квітучими садами внизу створює неповторну атмосферу, яку можна відчути лише в Черкасах."
}
        },
        "sosnivskyi-park": {
            img: "pictures/sosb1.jpg",
            imgAlt: "Pine trees in Sosnivskyi Park in Cherkasy",
           en: {
    ...
    const openModal = (placeKey) => {
        ...
        if (modalImage) {
            if (place.img) {
                ...
                modalImage.alt = place.imgAlt || langData.title || "";
